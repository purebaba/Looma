...
import { Bot, Mail, Lock, Eye, EyeOff, Github, Loader2 } from "lucide-react";
    ...
    <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-center lg:bg-gradient-to-br lg:from-[#667EEA] lg:to-[#764BA2] lg:px-12">
      <div className="max-w-lg space-y-6 text-center">
        <div className="flex items-center justify-center gap-3">
          ...
          <span className="text-[28px] font-bold text-white">Looma</span>
        </div>
        ...
        <p className="text-lg text-white/90">
          AI-native zero-code platform for modern teams
        </p>
        
        <div className="flex items-center justify-center gap-3 pt-4">
          <span className="px-4 py-1.5 rounded-full bg-white/20 text-sm text-white">No-Code</span>
          <span className="px-4 py-1.5 rounded-full bg-white/20 text-sm text-white">AI-Powered</span>
          <span className="px-4 py-1.5 rounded-full bg-white/20 text-sm text-white">Visual</span>
        </div>
      </div>
    </div>
  );
      ...
      <div className="flex-1 flex items-center justify-center bg-white p-4 sm:p-8">
        <div className="w-full max-w-[400px]">
          <div className="hidden sm:flex items-center justify-between mb-8">
            ...
            <Link
              href="/register"
              className="px-4 py-2 text-sm font-medium text-indigo-600 bg-slate-100 rounded-lg hover:bg-slate-200 transition-colors"
            >
              注册
            </Link>
          </div>
            ...
            <CardHeader className="sm:hidden space-y-1 pb-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-lg font-bold text-slate-900">Looma</span>
                </div>
